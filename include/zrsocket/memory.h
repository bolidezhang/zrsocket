...
#define ZRSOCKET_USE_CUSTOM_MEMCPY 1
#endif

//因zrsocket::Memory::memcpy在ios下可能会崩毁,
//所以在非windows下需要定义宏ZRSOCKET_USE_CUSTOM_MEMCPY来启用zrsocket_memcpy实现为zrsocket::Memory::memcpy
#if ZRSOCKET_USE_CUSTOM_MEMCPY
